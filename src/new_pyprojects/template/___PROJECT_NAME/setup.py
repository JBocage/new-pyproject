...
from src.___PROCESSED_NAME import __DESCRIPTION__, __PACKAGE_NAME__, __VERSION__
...
setup(
    ...
    author="___AUTHOR_NAME",  # F:AUTHOR
    author_email="___AUTHOR_EMAIL",  # F:AUTHOREMAIL
    classifiers=[
    ...
    entry_points={  # F:CLI
        "console_scripts": ["___CLI_NAME = ___PROCESSED_NAME.cli.main:cli"]  # F:CLI
    },  # F:CLI
)
